...
function replacement() {
    ...
    local filelink="https://web.archive.org/web/20230115225338/https://victor.poshtiban.io/p/gictor/photoshopCC/replacement.tgz"
...
function install_photoshopSE() {
    ...
    local filelink="https://web.archive.org/web/20230115225339/https://victor.poshtiban.io/p/gictor/photoshopCC/photoshopCC-V19.1.6-2018x64.tgz"
